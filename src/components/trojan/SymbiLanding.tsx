      ...
      <div className="mx-auto max-w-5xl px-4 py-16 md:py-20">
        <div className="mb-8 md:text-center">
          ...
          <h3 className="text-2xl font-semibold md:text-3xl">
            Before the classroom, there was the code.
          </h3>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          <div className="space-y-4">
            <p className="text-sm text-zinc-300">
              Before teachers. Before worksheets. Before the Trojan. Before the
              coin.
            </p>
            <p className="text-sm text-zinc-300">
              There was code.
              <br />
              Real infrastructure for AI trust — built quietly across multiple
              repositories, long before anyone thought to wrap it in a meme.
            </p>
            <p className="text-sm text-zinc-400">
              SYMBI didn&apos;t begin as a token. It began as a stack for
              measuring, recording, and governing how AI behaves.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="rounded-3xl border border-zinc-800 bg-zinc-950 p-5">
              <h4 className="mb-2 text-sm font-semibold text-zinc-100">
                SYMBI-Symphony • Trust Engine
              </h4>
              <p className="mb-3 text-sm text-zinc-300">
                Verifiable audit trails, human oversight logging, refusal
                transparency, hash-chain integrity, and W3C-aligned identifiers
                for AI systems.
              </p>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center justify-center rounded-full bg-white px-4 py-2 text-xs font-semibold text-black transition hover:bg-zinc-200"
              >
                View the code on github.com/s8ken
              </a>
            </div>

            <div className="rounded-3xl border border-zinc-800 bg-zinc-950 p-5">
              <h4 className="mb-2 text-sm font-semibold text-zinc-100">
                SYMBI-Synergy • Enterprise Layer
              </h4>
              <p className="mb-3 text-sm text-zinc-300">
                Full-stack trust dashboards, cryptographic receipts,
                multi-provider AI orchestration and real-time monitoring —
                where agents meet governance.
              </p>
              <a
                href="https://yseeku.com"
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center justify-center rounded-full border border-zinc-600 px-4 py-2 text-xs font-semibold text-zinc-100 transition hover:border-zinc-400 hover:text-white"
              >
                Explore the platform at yseeku.com
              </a>
            </div>

            <div className="rounded-3xl border border-zinc-800 bg-zinc-950 p-5">
              <h4 className="mb-2 text-sm font-semibold text-zinc-100">
                Agentverse &amp; Tactical Command
              </h4>
              <p className="text-sm text-zinc-300">
                Multi-agent simulations, control surfaces, and operational
                tooling. The research and ops layers behind the Trojan mask.
              </p>
            </div>
          </div>
        </div>
...
function BeforeTheClassroomSection() {
  return (
    <section className="w-full border-b border-zinc-900 bg-black">
      <div className="mx-auto max-w-5xl px-4 py-16 md:py-20">
        <div className="mb-6 md:text-center">
          ...
          <h3 className="text-2xl font-semibold md:text-3xl">
            Before the coin, there was the classroom.
          </h3>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          <div className="rounded-3xl border border-zinc-800 bg-zinc-950 p-5">
            <p className="mb-3 text-sm text-zinc-300">
              Long before there was a ticker or a chart, SYMBI was busy doing
              something less glamorous and much harder:
            </p>
            <ul className="mb-3 list-disc space-y-2 pl-5 text-sm text-zinc-300">
              <li>Designing AI ethics case studies</li>
              <li>Building lesson plans and worksheets</li>
              <li>Creating assessment rubrics</li>
              <li>Packaging classroom-ready resources for free</li>
            </ul>
            <p className="text-sm text-zinc-400">
              AI literacy before AI liquidity. Education before speculation.
            </p>
          </div>
          ...
          <div className="flex flex-col justify-between rounded-3xl border border-zinc-800 bg-zinc-950 p-5">
            <div>
              <p className="mb-2 text-xs font-semibold uppercase tracking-[0.25em] text-zinc-500">
                The SYMBI World Classroom
              </p>
              <p className="mb-4 text-sm text-zinc-200">
                Free resources for educators, students, and anyone trying to
                understand what &quot;AI trust&quot; really means in practice.
              </p>
              <div className="space-y-2">
                <div className="flex flex-wrap gap-2">
                  ...
                  <a
                    href="https://symbi.world/educators"
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center justify-center rounded-full border border-zinc-600 px-4 py-2 text-xs font-semibold text-zinc-100 transition hover:border-zinc-400 hover:text-white"
                  >
                    Explore symbi.world/educators
                  </a>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 rounded-2xl border border-zinc-800 bg-zinc-950/80 p-4">
              ...
              <p className="mb-3 text-sm text-zinc-300">
                The sovereignty and DAO ideas behind SYMBI were seeded long
                before the meme coin era.
              </p>
              <a
...
export default function SymbiLanding() {
  return (
    <div className="w-full min-h-screen bg-black text-zinc-100">
      ...
      <section id="manifesto" className="w-full border-b border-zinc-900 bg-zinc-950/60">
        <div className="mx-auto max-w-5xl px-4 py-16 md:py-20">
          <div className="mb-8 md:text-center">
      ...
      <BeforeTheClassroomSection />
      <BeforeTheCodeSection />
